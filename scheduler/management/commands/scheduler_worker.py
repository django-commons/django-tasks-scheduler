...
class Command(BaseCommand):
    """
    Runs RQ workers on specified queues. Note that all queues passed into a single scheduler_worker command must share
    the same connection.
    ...
    def handle(self, **options):
        ...
        try:
            ...
            w.work(
                ...
                with_scheduler=options.get("with_scheduler", True),
            )
