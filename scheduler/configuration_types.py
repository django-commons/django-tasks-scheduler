...
class SchedulerConfig:
    ...
    CALLBACK_TIMEOUT:int = 60  # Callback timeout in seconds (success/failure)
    ...
    DEFAULT_WORKER_TTL:int = 420  # Time To Live (TTL) in seconds to keep worker information after last heartbeat
