...
class ZSetModel(BaseModel):
    ...
    def add(self, connection: ConnectionType, member: str, score: float, update_existing_only: bool = False) -> int:
...
class JobNamesRegistry(ZSetModel):
    ...
    def pop(
        ...
        if timeout is not None:  # blocking variant
            ...
            registry_key, job_id, timestamp = result
            return as_str(registry_key), as_str(job_id)
